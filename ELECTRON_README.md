...
- **Glassmorphism Design**: Dark theme with translucent glass effects and vibrant green accents
- **Instance Management**: Create, rename, delete, and reorder Minecraft instances
- **Drag & Drop**: Reorder instances by dragging in the sidebar
- **Mod Loader Support**: Vanilla, Fabric, and Quilt
- **Modrinth Integration**: Browse and install modpacks directly from Modrinth
- **Java Auto-Detection**: Automatically find Java installations on your system
- **Import Support**: Import .zip and .mrpack modpack files
- **Console Logs**: Optional real-time Minecraft console output
